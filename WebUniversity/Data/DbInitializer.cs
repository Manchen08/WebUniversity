...
namespace WebUniversity.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
                new Student { FirstName = "Daniel",   LastName = "Bigelow",
                    EnrollmentDate = DateTime.Parse("2013-09-01") },
                new Student { FirstName = "Daniel", LastName = "Bowen",
                    EnrollmentDate = DateTime.Parse("2015-09-01") },
                new Student { FirstName = "Kole",   LastName = "Frazier",
                    EnrollmentDate = DateTime.Parse("2016-09-01") },
                new Student { FirstName = "Jed",    LastName = "Krause",
                    EnrollmentDate = DateTime.Parse("2015-09-01") },
                new Student { FirstName = "Jonathan",      LastName = "Wheeler",
                    EnrollmentDate = DateTime.Parse("2015-09-01") },
                new Student { FirstName = "Jared",    LastName = "Williams",
                    EnrollmentDate = DateTime.Parse("2014-09-01") },
                new Student { FirstName = "Joseph",    LastName = "Smith",
                    EnrollmentDate = DateTime.Parse("2013-09-01") },
                new Student { FirstName = "Brigham",     LastName = "Young",
                    EnrollmentDate = DateTime.Parse("2015-09-01") }
            };
